...
function formatSensorReading(sensorType, unitSystem, parsedValues, evalResult) {
  ...
  if (normType.includes('PRESS')) {
    ...
    return `Press: ${pressVal !== undefined && pressVal !== null && pressVal !== '' ? pressVal : 'N/A'} ${displayUnit}`;
  }
  ...
  if (normType.includes('CURRENT') || normType.includes('PWR') || normType.includes('AC')) {
    ...
    return `Current: ${currVal !== undefined && currVal !== null && currVal !== '' ? currVal : 'N/A'} ${displayUnit}`;
  }
  ...
  if (normType.includes('WATER') || normType.includes('LEVEL')) {
    ...
    return `WaterLvl: ${wtrVal !== undefined && wtrVal !== null && wtrVal !== '' ? wtrVal : 'N/A'} ${displayUnit}`;
  }
  ...
  return `Temp: ${tempVal !== undefined && tempVal !== null && tempVal !== '' ? `${tempVal}${displayUnit}` : 'N/A'}`;
}
