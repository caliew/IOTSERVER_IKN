            ...
            if (_SHINKOIDs.includes(Number(payload._DTUID))) {
              ...
              _data.read('shinko','settings',function(err,settingData) {
                ...
                if (_ALERT && _FLAG) {
                  ...
                  decoders.WhatsAppGateway2('Shinko IOT Monitoring System',_MESSAGE)
                }
              })      
...
server.init = function () {
  ...
  server.tcpServer1020.listen(config.tcpPort1020, function () {console.log(`[${'SERVER.JS'.yellow}]  INIT TCP SERVER PORT ${String(config.tcpPort1020).magenta} - NIPPONGLASS`); });
