...
server.init = function () {
  ...
  // -------------------------------------
  // START TCP SERVER 1020 - NEW TEST SITE (IJN)
  // .. SHUTDOWN COMPLETION OF SITE TRIAL ...
  ...
  server.tcpServer1021.listen(config.tcpPort1020, function () {console.log(`[${'SERVER.JS'.yellow}]  INIT TCP SERVER PORT ${String(config.tcpPort1020).magenta}`); });
