                  ...
                  _data.read(FileName,'settings',function(err,settingData) {
                    ...
                    switch (_TYPE) {
                      ...
                      case 'AIR PRESSURE':
                          ...
                          _FALSESIGNAL = _READINGTEMP > Number(filterLIMITS['PRESSURE_MAX']) || _READINGTEMP < Number(filterLIMITS['PRESSURE_MIN']);
                ...
                _data.read(FileName,'settings',function(err,settingData) {
                  ...
                  switch (_TYPE) {
                    ...
                    case 'TEMP & RH':
                      ...
                      _ALERTObj['RH'] = _READINGRH;
                      let _FLAGTEMPRH = false;
                      let _FALSESIGNAL = _READINGTEMP > Number(filterLIMITS['TEMPERATURE_MAX']) || _READINGTEMP < Number(filterLIMITS['TEMPERATURE_MIN']);
                      if (_FALSESIGNAL) return;
                      //  ---------------
                      _FLAG = (_TEMPMAX == null) ? false : (Number(_READINGTEMP) > Number(_TEMPMAX)) ? true: false;
                      _FLAG && (_MESSAGE += ` TEMP=${_READINGTEMP}>${_TEMPMAX}C`);
...
server.init = function () {
  ...
  false && startTCPServer('AEROSOFT',config.tcpPort1088,false);      // TRANS
