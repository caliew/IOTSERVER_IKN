 ...
 */
 ...
 const nTIMER2 = 20;    // TDKSENSORSGROUP
...
workers.SERVER_STATUS_UPDATE = function(nInterval) {
  ...
  let LoopInterval = setInterval(function() {
    ...
    if (today.getMinutes()%60 == 0) {
      ...
      decoder.WhatMateMessage('IKN LoRa IOT Group',`..${today.getMinutes()}..<${nHOURLY}> HOURLY UPDATE..`);
    ...
    // -------------
    let bypass = true;
    if (today.getMinutes()%42 == 0 && !bypass) {
      // -------
