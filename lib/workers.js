     ...
     if (today.getMinutes()%nTIMER1 == 0) {
      ...
      _logs.read('_TEAWAREHOUSEALERTS',nTotalLines,_day0,_day1,false,function(err,alertsData){
        ...
        if (strMessage1.length > 10) {
          console.log(ObjKEYS,WhatsAppGroup1,strMessage1.length);
    ...
    if (today.getMinutes()%nTIMER2 == 0) {
      ...
      _logs.read('_TDKALERTS',nTotalLines,_day0,_day1,false,function(err,alertsData){
        ...
        if (strMessage2.length > 10) {
          console.log(ObjKEYS,WhatsAppGroup2,strMessage2.length);
...
const GetAlertsMessage2 = (Alerts) => {
  ...
  Alerts.map((alert)=>{
    ...
    let _DATE = new Date(alert.TIMESTAMP);
    let _DATETIME = `${_DATE.getHours()}:${_DATE.getMinutes()}`;
    strTEXT += `${_DATETIME} ${alert.sensorType} ${alert.sign} ${alert.LIMITS}%\r`;
  })
  return strTEXT;
}
// -------
