...
decoders.decodeF8L10ST_APIMODE= function(PORTID,buffer,blnDEBUG,callback) {
  ...
  // const _PRE = PRE;
  // const _DATA = POST;
  blnDEBUG && console.log(`[${"DECODERS.JS".green}] PORT=<${String(PORTID).red}> LINE:577 ..DECODEF8L10ST.. BUFFER=<${String(buffer).green}>`);
  blnDEBUG && console.log(`[${"DECODERS.JS".green}] PORT=<${String(PORTID).red}> LINE:578 ..DECODEF8L10ST.. PRE=<${String(_PRE).red}> DATA=<${String(_DATA).yellow}`);
  blnDEBUG && console.log(`[${"DECODERS.JS".green}] PORT=<${String(PORTID).red}> LINE:579 ..DECODEF8L10ST.. PRE=<${String(_PRE).red}> <${String(_DATA.length).yellow}|${truncateString(_DATA,20).green}>`);
...
decoders.TelegramGateway10 = function(whatsAppGroup,message) {
  // --------------------------
  console.log(`[${getDateTimeStamp()}] DECODER =>${String("TELEGRAMGATEWAY10").yellow} [${whatsAppGroup.red}] ..${message.blue}`)
...
decoders.TelegramGateway12 = function(whatsAppGroup,message) {
  // --------------------------
  console.log(`[${getDateTimeStamp()}] DECODER =>${String("TELEGRAMGATEWAY12").yellow} [${whatsAppGroup.red}] ..${message.blue}`)
  var jsonPayload = JSON.stringify({
    group_admin: "6597668621", // TODO: Specify the WhatsApp number of the group creator, including the country code
    group_name: whatsAppGroup,   // TODO:  Specify the name of the group
    message: message  // TODO: Specify the content of your message
    ...
    request.on('response', function (response) {
      ...
      response.on('data', function (chunk) {
        try {
          let object = JSON.parse(chunk);
          console.log(`...ID=${object?.id} RESULT=${object?.result}`);
          _logs.append('_WHATSMATE_TELEGRAM',`[WHATSMATE ACCOUNT 2] ${getDateTimeStamp()} ${whatsAppGroup} ..${object?.id}/${object?.result}`,()=>{});
        } catch (err1) {
...
decoders.WhatsAppGateway28 = function(whatsAppGroup,message) {
  // --------------------------
  console.log(`[${getDateTimeStamp()}] DECODER =>${String("WHATSAPPGATEWAY28").yellow} [${whatsAppGroup}] ..${message}`)
  var jsonPayload = JSON.stringify({
    group_admin: "6597668621", // TODO: Specify the WhatsApp number of the group creator, including the country code
    group_name: whatsAppGroup,   // TODO:  Specify the name of the group
    message: message  // TODO: Specify the content of your message
...
decoders.WhatsAppGateway30 = function(whatsAppGroup,message) {
  // --------------------------
  console.log(`[${getDateTimeStamp()}] DECODER =>${String("WHATSAPPGATEWAY30").yellow} [${whatsAppGroup.red}] ..${message.blue}`)
  var jsonPayload = JSON.stringify({
    group_admin: "6597668621", // TODO: Specify the WhatsApp number of the group creator, including the country code
    group_name: whatsAppGroup,   // TODO:  Specify the name of the group
    message: message  // TODO: Specify the content of your message
