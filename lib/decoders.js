...
decoders.decodeWISensorV2 = function (PortID, blnDEBUG, BUFFERDATA, callback) {
  ...
  blnDEBUG && console.log(`[${"DECODERS.JS".green}] PORT=<${String(PortID).red}> ..DECODEWISENSORV2.. DATA=<${String(_DATA).green}>`);
...
decoders.decodeF8L10ST= function(PORTID,buffer,blnDEBUG,callback) {
  ...
  false && _logs.append(_PORTIDFile,`..${PORTID}..${getDateTimeStamp()} PORT=<${PORTID}> BYTE=<${_PRE}>..<${_DATA}>`,()=>{});
  // ------------------------------
