...
decoders.TelegramGateway = function(whatsAppGroup,message) {
  // --------------------------
  console.log(`DECODER =>${String("TELEGRAMGATEWAY1").yellow} [${whatsAppGroup.red}] ..${message.blue}`)
...
decoders.WhatsAppGateway1 = function(whatsAppGroup,message) {
  // --------------------------
  console.log(`DECODER =>${String("WHATSAPPGATEWAY1").yellow} [${whatsAppGroup.red}] ..${message.blue}`)
  var jsonPayload = JSON.stringify({
    group_admin: "6597668621", // TODO: Specify the WhatsApp number of the group creator, including the country code
    group_name: whatsAppGroup,   // TODO:  Specify the name of the group
    message: message  // TODO: Specify the content of your message
...
decoders.WhatsAppGateway2 = function(whatsAppGroup,message) {
  // --------------------------
  console.log(`DECODER =>${String("WHATSAPPGATEWAY2").yellow} [${whatsAppGroup.red}] ..${message.blue}`);
  var jsonPayload = JSON.stringify({
    group_admin: "6597668621", // TODO: Specify the WhatsApp number of the group creator, including the country code
    group_name: whatsAppGroup,   // TODO:  Specify the name of the group
    message: message  // TODO: Specify the content of your message
  ...
  try {
    ...
    request.on('response', function (response) {
      ...
      response.on('data', function (chunk) {
        try {
          let object = JSON.parse(chunk);
          _logs.append('_WHATSMATE_WHATSAPP2',`[WHATSMATE ACCOUNT 2] ${getDateTimeStamp()} ${whatsAppGroup} ..${object?.id}/${object?.result}`,()=>{});
        } catch (err1) {
          console.log('[GATEWAY2] ERROR PARSING JSON:',err1.message);
        }
      });
...
decoders.WhatsAppGateway3 = function(whatsAppGroup,message) {
  // --------------------------
  console.log(`DECODER =>${String("WHATSAPPGATEWAY3").yellow} [${whatsAppGroup}] ..${message}`)
  var jsonPayload = JSON.stringify({
    group_admin: "6597668621", // TODO: Specify the WhatsApp number of the group creator, including the country code
    group_name: whatsAppGroup,   // TODO:  Specify the name of the group
    message: message  // TODO: Specify the content of your message
...
decoders.WhatsAppGateway4 = function(whatsAppGroup,message) {
  // --------------------------
  console.log(`DECODER =>${String("WHATSAPPGATEWAY4").yellow} [${whatsAppGroup.red}] ..${message.blue}`)
  var jsonPayload = JSON.stringify({
    group_admin: "6597668621", // TODO: Specify the WhatsApp number of the group creator, including the country code
    group_name: whatsAppGroup,   // TODO:  Specify the name of the group
    message: message  // TODO: Specify the content of your message
